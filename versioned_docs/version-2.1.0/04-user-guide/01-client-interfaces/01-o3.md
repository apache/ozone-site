...
<!--
If the key is in an [FSO](../../system-internals/features/filesystem-optimization) bucket it will be moved to the trash when deleted. Below is the trash location:
-->
