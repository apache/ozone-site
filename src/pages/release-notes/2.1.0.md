...
*   **HDDS-10239 | Storage Container Reconciliation:** Introduced a container reconciliation protocol to resolve mismatched container states and verify replica integrity.
*   **HDDS-12940 | Ozone Snapshot Phase 3: Scale up Snapshot Operations:** Enhanced Ozone Snapshot scalability and continued stability improvements.
*   **HDDS-8387 | Container and volume scanners phase II:** Enhanced storage volume failure handling by introducing a 'degraded' state to preserve data availability, along with improved health observability.
*   **HDDS-12564 | Handling disk issues in Datanodes - Phase II:** Enhanced Datanode disk space management to prevent out-of-space failures.
...
*   Security Ranger: Added artifacts for Ranger to authorize STS tokens. (HDDS-13848)