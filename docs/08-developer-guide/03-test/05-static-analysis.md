...
[https://sonarcloud.io/project/overview?id=apache_ozone](https://sonarcloud.io/project/overview?id=apache_ozone)
...
1. **Blocker**: Issues that must be fixed immediately (risk of system failure)
2. **Critical**: High-impact issues requiring urgent attention
3. **Major**: Default severity for most issues
4. **Minor**: Low-impact issues with minimal risk
5. **Info**: Non-critical issues that represent best practice violations
