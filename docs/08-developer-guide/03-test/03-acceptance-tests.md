...
Robot Framework tests are written in `.robot` files with a structured format:
...
./test.sh ozone basic/basic.robot
...
### 3. High Availability (HA) Environment
