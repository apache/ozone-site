...
If the key is in an [FSO](../../core-concepts/namespace/buckets/layouts/file-system-optimized) bucket it will be moved to the trash when deleted. Below is the trash location:
