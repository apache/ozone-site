...
- [Overview](./overview) — the Open Keys and Delete Pending Keys summary cards link here.
- [Containers](./containers) — container health and unhealthy-state detail.
- [Insights](./insights) — file-size and container-size distribution charts.
- [Namespace Usage](./namespace-usage) — size usage explored by path.
