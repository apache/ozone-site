...
1.  **Download a Release:**
    ...
    *   Instructions for unpacking and configuring the downloaded binaries are detailed in the **[Bare Metal Installation Guide](../../../02-quick-start/01-installation/03-bare-metal.md)**.
...
2.  **Build from Source:**
    ...
    *   Instructions for building Ozone using Maven can be found in the **[Maven Build Guide](../../../08-developer-guide/01-build/01-maven.md)**.
    *   Once built, the installation process follows the same steps outlined in the **[Bare Metal Installation Guide](../../../02-quick-start/01-installation/03-bare-metal.md)**, using the locally built distribution tarball or directory.
