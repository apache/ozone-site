...
In this case, the Hadoop RPC encryption configuration is not applicable. Refer to the [Configuring gRPC With TLS](./grpc) page to encrypt gRPC-based communication.
